import type { Component, JSX, ParentProps, ValidComponent } from 'solid-js';
...
interface MultiSelectProps<T> {
  ...
  options: T[];
  placeholder?: string;
  itemComponent: Component<SelectPrimitive.SelectRootItemComponentProps<T>>;
}

const MultiSelect = <T extends object | string>(
  props: MultiSelectProps<T> & ParentProps
) => {
  return (
    <Select<T>
      multiple
